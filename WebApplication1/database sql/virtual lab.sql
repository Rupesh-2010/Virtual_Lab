...
INSERT INTO `solvedassignment` VALUES (1,'session','abcd','abc','ab','new Edited','Erd.png');
...
INSERT INTO `tbl_assignment` VALUES (1,'ggs','Erd.png','Shivraj colefe','sarf','BCS','new Sub'),(2,'null','Erd.png','Shivraj colefe','sarf','BCS','gggg'),(3,'check','Erd.png','Blank','new new','BCA','new Sub'),(4,'new Edited','wallpaperflare.com_wallpaper.jpg','abcd','abc','ab','new Sub'),(5,'yoyo','wallpaperflare.com_wallpaper.jpg','abcd','abc','ab','new Sub');
...
INSERT INTO `tbl_class` VALUES (1,'BCS','Erd.png','new Description','new','new new'),(7,'BCA','Erd.png','BCa Desc','','Shinde dep'),(8,'ab','wallpaperflare.com_wallpaper.jpg','session','abcd','abc');
...
INSERT INTO `tbl_department` VALUES (5,'','safsaf','SHREE5532.png','ggs'),(7,'','sarf','','d'),(9,'new','new new','','gg'),(17,'new','Shinde dep','','shinde dep sc'),(18,'abcd','abc','wallpaperflare.com_wallpaper.jpg','session test');
...
INSERT INTO `tbl_notes` VALUES (3,'Notes','Erd.png','Desciption Note','Ghali college','Shinde dep','BCS','new Sub'),(4,'session','wallpaperflare.com_wallpaper.jpg','session','session','session','session','session');
...
INSERT INTO `tbl_result` VALUES (2,'Erd.png','shivraj','Shinde dep','BCS','new Sub','Fail'),(3,'Erd.png','ss','Shinde dep','BCA','new Sub','Result Title'),(5,'null','Shivraj colefe','safsaf','BCS','new Sub','piyushadake9');
...
INSERT INTO `tbl_syllabus` VALUES (1,'asfasf','Erd.png','Shivraj colefe','sarf','BCS','new Sub'),(2,'session','wallpaperflare.com_wallpaper.jpg','abcd','abc','ab','session');
...
INSERT INTO `tbl_videos` VALUES (4,'video Title','Erd.png','Desc video','Addded','Shinde dep','null','new Sub'),(5,'session','wallpaperflare.com_wallpaper.jpg','session','session','session','null','session');
...
-- Dump completed on 2023-05-01 16:20:24
