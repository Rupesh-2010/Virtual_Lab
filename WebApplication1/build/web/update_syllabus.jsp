        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Syllabus Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h1 class="card-title">Syllabus</h1>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="addsyllabus" method="POST">
                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="syllabus_id" value="<%=request.getParameter("syllabus_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                    <div class="row mb-2">
          <div class="col-sm-6">
                          ...
                          }catch(Exception ex)
{
                    ...
                    <div class="form-group">
                    <label for="Inputcollegename">Syllabus Title</label>
                    <input type="text" class="form-control" value="<%=request.getParameter("syllabus_title")%>" id="Inputcollegename" placeholder="Enter Syllabus Title" onkeypress="javascript:return isString(event)" name="syllabustitle">
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                  <div class="form-group">
                    <label for="exampleInputFile">Syllabus PDF/File</label>
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" value="<%=request.getParameter("syllabus_file")%>" id="NotesInputFile" name="syllabusfile">
