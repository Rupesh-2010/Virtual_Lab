        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item ">
                <a href="listexperiment.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Practical</p>
                </a>
              </li>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
           ...
           String sql="select * from tbl_experiment";
         ...
         <form action="update_experiment.jsp" method="POST">
                <th scope="row"><%=counter++%></th>
               <input type="hidden" name="experiment_id" value="<%=rs.getString("experiment_id")%>" >   
        ...
        <input type="hidden" name="class" value="<%=rs.getString("class")%>">
        <td><%=rs.getString("subject")%></td>
        <input type="hidden" name="subject" value="<%=rs.getString("subject")%>">
        <td><%=rs.getString("experiment_name")%></td>
        <input type="hidden" name="experiment_name" value="<%=rs.getString("experiment_name")%>">
        <td><%=rs.getString("compiler_link")%></td>
        <input type="hidden" name="compiler_link" value="<%=rs.getString("compiler_link")%>">
        <td><%=rs.getString("experiment_file")%></td>
        <input type="hidden" name="experiment_file" value="<%=rs.getString("experiment_file")%>">
        <td><%=rs.getString("experiment_descrip")%></td>
        <input type="hidden" name="experiment_descrip" value="<%=rs.getString("experiment_descrip")%>">
