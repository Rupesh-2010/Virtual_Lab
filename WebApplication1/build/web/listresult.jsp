        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item ">
                <a href="listresult.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Result</p>
                </a>
              </li>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
           ...
           String sql="select * from tbl_result";
         ...
         <form action="update_result.jsp" method="POST">
               ...
               <input type="hidden" name="result_id" value="<%=rs.getString("result_id")%>" >   
        ...
        <td><%=rs.getString("result_file")%></td>
        <input type="hidden" name="result_file" value="<%=rs.getString("result_file")%>">
