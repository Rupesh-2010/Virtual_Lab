        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Class Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form action="addclass" method="POST">
                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="class_id" value="<%=request.getParameter("class_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                    <div class="row mb-2">
          <div class="col-sm-6">
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="Inputcollegename">Class Name</label>
                    <input type="text" class="form-control" value="<%=request.getParameter("class_name")%>" id="Inputcollegename" placeholder="Enter class name" onkeypress="javascript:return isString(event)" name="classname">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Class Image/File</label>
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" value="<%=request.getParameter("class_img")%>" id="collegeInputFile" name="classimg">
                  ...
                  <div class="form-group">
                        ...
                        <textarea name="classdesc" class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"><%=request.getParameter("class_descrip")%></textarea>
                      </div>
