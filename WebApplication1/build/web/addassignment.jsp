        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                  <a href="addassignment.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Assignment</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Result Practical Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                          ...
                          }catch(Exception ex)
{
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Inputusername" placeholder="Assignment Title" onkeypress="javascript:return isAlphanumric(event)" name="assi_title">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="resultInputFile" name="assi_File">
                ...
                <div class="col-md-2">
                  <a href="listassignment.jsp" class="btn btn-warning" >Edit</a>
                </div>
