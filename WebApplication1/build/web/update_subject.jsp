        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Subject Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form action="addsubject" method="POST">
                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="subject_id" value="<%=request.getParameter("subject_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                    <div class="row mb-2">
          <div class="col-sm-6">
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                <div class="form-group">
                  <label for="class_name">College</label>
                  <select class="custom-select form-control-border" id="departmentSelect" name="class_name">
...
<div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<%=request.getParameter("subject_name")%>" id="Inputcollegename" placeholder="Enter Class name" onkeypress="javascript:return isString(event)" name="subname">
                  </div>
                </div>
              </div>
                  ...
                  <div class="form-group">
                        ...
                        <textarea name="subdesc" class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"><%=request.getParameter("subject_descrip")%></textarea>
                      </div>
