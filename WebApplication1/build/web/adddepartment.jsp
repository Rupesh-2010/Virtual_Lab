        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Department Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                          ...
                          }catch(Exception ex)
{
              ...
              <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Inputcollegename" name="deptname" placeholder="Enter Department name" onkeypress="javascript:return isString(event)">
          ...
          <div class="col-sm-6">
                  <div class="form-group">
                    <label for="deptInputFile">Department Image/File</label>
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" id="deptInputFile" name="deptimg">
                        <label class="custom-file-label" for="deptInputFile">Choose file</label>
                      </div>
                      <div class="input-group-append">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" name="deptdesc" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"></textarea>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-2">
                 <a href="listdepartment.jsp" class="btn btn-warning" >Edit</a>
                </div>
