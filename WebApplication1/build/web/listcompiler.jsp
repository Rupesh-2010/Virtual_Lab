        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item ">
                <a href="listcompiler.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Compiler</p>
                </a>
              </li>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
         ...
         <form action="update_compiler.jsp" method="POST">
                <th scope="row"><%=counter++%></th>
               <input type="hidden" name="compiler_id" value="<%=rs.getString("compiler_id")%>" >   
             
        
        <td><%=rs.getString("compiler_name")%></td>
        <input type="hidden" name="compiler_name" value="<%=rs.getString("compiler_name")%>">
