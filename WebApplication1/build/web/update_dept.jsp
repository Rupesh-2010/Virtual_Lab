        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Department Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form action="adddepartment" method="POST">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="dept_id" value="<%=request.getParameter("dept_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                    <div class="col-sm-6">
                  <div class="form-group">
                  <label for="college">College</label>
                  <select class="custom-select form-control-border" id="college" name="college">
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<%=request.getParameter("dept_name")%>" id="Inputcollegename" placeholder="Enter College name" onkeypress="javascript:return isString(event)" name="deptname">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" value="<%=request.getParameter("dept_img")%>" id="collegeInputFile" name="deptimg">
                  ...
                  <div class="form-group">
                        ...
                        <textarea name="deptdesc" class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"><%=request.getParameter("dept_descrip")%></textarea>
                      </div>
