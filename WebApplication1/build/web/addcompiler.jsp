        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addcompiler.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Compiler</p>
                </a>
              </li>
...
<div class="col-sm-3">
          ...
          <div class="col-sm-4">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Compiler Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="col-md-3">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Compiler</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
            ...
            try
        {
         ...
         String sql="select compiler_id from tbl_compiler";
         ResultSet rs= st.executeQuery(sql);
         while(rs.next())
         { 
           id=String.valueOf(Integer.parseInt(rs.getString("compiler_id"))+1);
         }
...
%>
                <div class="card-body">
                  ...
                  <select class="custom-select form-control-border" id="collegeSelect">
                    <option>Shivraj college</option>
                    <option>Ghali College</option>
                    <option>A D Shinde College</option>
                  </select>
                </div>

                  <div class="form-group">
                  <label for="departmentSelect">Department</label>
                  <select class="custom-select form-control-border" id="departmentSelect">
                ...
                <div class="form-group">
                  ...
                  <select class="custom-select form-control-border" id="classSelect">
                    <option>BCS</option>
                    <option>B.Sc</option>
                    <option>BCA</option>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="Inputcompilername">Compiler Name</label>
                    <input type="text" class="form-control" id="Inputcompilername" placeholder="Enter Compile Title" name="compilername">
                  </div>

                  <div class="form-group">
                    <label for="Inputcompilerlink">Compiler link</label>
                    <input type="text" class="form-control" id="Inputcompilerlink" placeholder="Enter Link" name="compilerlink">
                  </div>
                ...
                <div class="col-sm-2">
                    <a href="listcompiler.jsp" class="btn btn-warning" >Edit</a>
                </div>
