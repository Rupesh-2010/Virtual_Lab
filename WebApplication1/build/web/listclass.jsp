        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ">
                ...
                <a href="listdepartment.jsp" class="nav-link ">
                  ...
                  <p>List Department</p>
                            ...
                            <li class="nav-item ">
                <a href="listclass.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Class</p>
                </a>
              </li>
              ...
              <li class="nav-item ">
                  <a href="listsolvedassignmentjsp" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
         ...
         <form action="update_class.jsp" method="POST">
                <th scope="row"><%=counter++%></th>
               <input type="hidden" name="class_id" value="<%=rs.getString("class_id")%>" >   
        ...
        <td><%=rs.getString("class_img")%></td>
        <input type="hidden" name="class_img" value="<%=rs.getString("class_img")%>">
        
        <td><%=rs.getString("class_descrip")%></td>
        <input type="hidden" name="class_descrip" value="<%=rs.getString("class_descrip")%>">
