      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ">
                <a href="listcollege.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List College</p>
                </a>
              </li>
   ...
   Statement st=null;
    int counter=1;
       ...
       try
       {
           ...
           <tbody>
            <tr>
           <form action="update_college.jsp" method="post">
               <th scope="row"><%=counter++%></th>
               <input type="hidden" name="collage_id" value="<%=rs.getString("collage_id")%>" >
        <td><%=rs.getString("collage_name")%></td>
        <input type="hidden" name="collage_name" value="<%=rs.getString("collage_name")%>">
        <td><%=rs.getString("collage_img")%></td>
        <input type="hidden" name="collage_img" value="<%=rs.getString("collage_img")%>">
        <td><%=rs.getString("collage_descrip")%></td>
        <input type="hidden" name="collage_descrip" value="<%=rs.getString("collage_descrip")%>">
