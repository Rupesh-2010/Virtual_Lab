        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addsyllabus.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Syllabus</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Syllabus Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                  <div class="form-group">
                    <label for="InputVideotitle">Syllabus Title</label>
                    <input type="text" class="form-control" id="InputVideotitle" placeholder="Enter Syllabus Title"onkeypress="javascript:return isString(event)" name="syllabustitle">
                  </div>
                </div>

                 <div class="col-sm-6">
                  <div class="form-group">
                    <label for="exampleInputFile">Syllabus File</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="videoInputFile" name="syllabusfile">
                ...
                <div class="col-md-2">
                  <a href="listsyllabus.jsp" class="btn btn-warning" >Edit</a>
                </div>
