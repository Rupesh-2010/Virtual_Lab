        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Video Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form action="addvideos" method="POST">
                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="video_id" value="<%=request.getParameter("video_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                    <div class="row mb-2">
          <div class="col-sm-6">
                          ...
                          }catch(Exception ex)
{
                    ...
                    <div class="form-group">
                    <label for="Inputcollegename">Video Title</label>
                    <input type="text" class="form-control" value="<%=request.getParameter("video_tile")%>" id="Inputcollegename" placeholder="Enter Title of Video" onkeypress="javascript:return isString(event)" name="videotitle">
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                  <div class="form-group">
                    <label for="exampleInputFile">Video PDF/File</label>
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" value="<%=request.getParameter("video_file")%>" id="NotesInputFile" name="videofile">
                  ...
                  <div class="form-group">
                        ...
                        <textarea name="videodesc" class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"><%=request.getParameter("video_descrip")%></textarea>
                      </div>
