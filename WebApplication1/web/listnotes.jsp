        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item ">
                <a href="listnotes.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Notes</p>
                </a>
              </li>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
         ...
         <form action="update_notes.jsp" method="POST">
                <th scope="row"><%=counter++%></th>
               <input type="hidden" name="notes_id" value="<%=rs.getString("notes_id")%>" >   
        ...
        <td><%=rs.getString("notes_title")%></td>
        <input type="hidden" name="notes_title" value="<%=rs.getString("notes_title")%>">
        <td><%=rs.getString("notes_file")%></td>
        <input type="hidden" name="notes_file" value="<%=rs.getString("notes_file")%>">
        <td><%=rs.getString("notes_descrip")%></td>
        <input type="hidden" name="notes_descrip" value="<%=rs.getString("notes_descrip")%>">
