        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addclass.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Class</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Class Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="row mb-2">
          <div class="col-sm-6">
                <div class="form-group">
                    <label for="Inputclassgename">Class Name</label>
                    <input type="text" class="form-control" id="Inputclassgename" placeholder="Enter class name" onkeypress="javascript:return isString(event)" name="classname">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" id="collegeInputFile" name="classimg" >
                  ...
                  <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)" name="classdesc"></textarea>
                      </div>
                ...
                <!-- /.card-body -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                        <button type="submit" class="btn btn-primary" value="Save" name="btn_save">Save</button>
                </div>
                <div class="col-sm-2">
                  <a href="listclass.jsp" class="btn btn-warning" >Edit</a>
                </div>
