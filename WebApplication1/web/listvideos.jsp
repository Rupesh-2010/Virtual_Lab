        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item ">
                <a href="listvideos.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Videos</p>
                </a>
              </li>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
           ...
           String sql="select * from tbl_videos";
         ...
         <form action="update_videos.jsp" method="POST">
             
                <th scope="row"><%=counter++%></th>
               <input type="hidden" name="video_id" value="<%=rs.getString("video_id")%>" >   
        ...
        <td><%=rs.getString("video_tile")%></td>
        <input type="hidden" name="video_tile" value="<%=rs.getString("video_tile")%>">	
        <td><%=rs.getString("video_file")%></td>	
        <input type="hidden" name="video_file" value="<%=rs.getString("video_file")%>">	
        <td><%=rs.getString("video_descrip")%></td>	
        <input type="hidden" name="video_descrip" value="<%=rs.getString("video_descrip")%>">
