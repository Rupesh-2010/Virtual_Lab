        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addsubject.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Subject</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Subject Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Inputsubjectname" placeholder="Enter Subject Name" onkeypress="javascript:return isString(event)" name="subname">
                  </div>
                </div>
              </div>
                  ...
                  <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)" name="subdesc"></textarea>
                      </div>
                ...
                <div class="col-md-2">
                  <a href="listsubject.jsp" class="btn btn-warning" >Edit</a>
                </div>
