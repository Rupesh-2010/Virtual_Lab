        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item ">
                  <a href="listassignment.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Assignment</p>
                </a>
              </li>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
         ...
         <form action="update_assignment.jsp" method="POST">
        ...
        <td><%=rs.getString("assi_File")%></td>
        <input type="hidden" name="assi_File" value="<%=rs.getString("assi_File")%>">
