        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item ">
                <a href="listsyllabus.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Syllabus</p>
                </a>
              </li>
  ...
  <%
   ...
   Statement st=null;
       ...
       try
       {
           ...
           String sql="select * from tbl_syllabus";
         ...
         <form action="update_syllabus.jsp" method="POST">
                <th scope="row"><%=counter++%></th>
               <input type="hidden" name="syllabus_id" value="<%=rs.getString("syllabus_id")%>" >   
        ...
        <td><%=rs.getString("syllabus_title")%></td>
        <input type="hidden" name="syllabus_title" value="<%=rs.getString("syllabus_title")%>">
        <td><%=rs.getString("syllabus_file")%></td>
        <input type="hidden" name="syllabus_file" value="<%=rs.getString("syllabus_file")%>">
