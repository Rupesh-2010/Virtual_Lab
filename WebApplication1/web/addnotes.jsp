        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addnotes.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Notes</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Notes Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                  <div class="form-group">
                    <label for="Inputnotestitle">Notes Title</label>
                    <input type="text" class="form-control" id="Inputnotestitle" placeholder="Enter Notes Title" onkeypress="javascript:return isString(event)" name="notestitle">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" id="NotesInputFile" name="notesfile">
                  ...
                  <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)" name="notesdesc"></textarea>
                      </div>
                ...
                <div class="col-md-2">
                   <a href="listnotes.jsp" class="btn btn-warning" >Edit</a>
                </div>
