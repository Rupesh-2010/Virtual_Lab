        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Notes Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form action="addnotes" method="POST">
                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="notes_id" value="<%=request.getParameter("notes_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                    <div class="row mb-2">
          <div class="col-sm-6">
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select class="custom-select form-control-border" id="collegeSelect" name="class_name">
                          ...
                          }catch(Exception ex)
{
                    ...
                    <div class="form-group">
                    <label for="Inputcollegename">Notes Title</label>
                    <input type="text" class="form-control" value="<%=request.getParameter("notes_title")%>" id="Inputcollegename" placeholder="Enter Notes name" onkeypress="javascript:return isString(event)" name="notestitle">
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                  <div class="form-group">
                    <label for="exampleInputFile">Notes PDF/File</label>
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" value="<%=request.getParameter("notes_file")%>" id="NotesInputFile" name="notesfile">
                  ...
                  <div class="form-group">
                        ...
                        <textarea name="notesdesc" class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"><%=request.getParameter("notes_descrip")%></textarea>
                      </div>
