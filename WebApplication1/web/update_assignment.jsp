          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="addresult.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Result</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Result assignment Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
%>
                <div class="card-body">
                    <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="assi_id" value="<%=request.getParameter("assi_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                   <div class="row mb-2">
          <div class="col-sm-6">
                          ...
                          }catch(Exception ex)
{
                  ...
                  <div class="row">
                      <div class="col-sm-6">
                  <div class="form-group">
                    <label for="Inputusername">Assignment title</label>
                    <input type="text" class="form-control" id="Inputusername"   value="<%=request.getParameter("assi_title")%>" placeholder="Assignment Title" onkeypress="javascript:return isAlphanumric(event)" name="assi_title">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="resultInputFile" name="assi_File"  value="<%=request.getParameter("assi_File")%>">
                        <label class="custom-file-label" for="resultInputFile">Choose file</label>
                      </div>
                      <div class="input-group-append">
                ...
                <div class="col-md-2">
                  <button type="submit" class="btn btn-danger" name="btn_save" value="Delete">Delete</button>
                </div>
                </div>
                </div>
              </form>
