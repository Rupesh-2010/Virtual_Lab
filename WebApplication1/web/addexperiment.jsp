        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addexperiment.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Practical</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Practical Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Practical</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                  <div class="form-group">
                    <label for="InputVideotitle">Practical Name</label>
                    <input type="text" class="form-control" id="InputVideotitle" placeholder="Enter Practical Title" onkeypress="javascript:return isString(event)" name="exptname">
                  </div>
                </div>
                 ...
                 <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Practical File</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="videoInputFile" name="exptfile">
                  ...
                  <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)" name="exptdesc"></textarea>
                      </div>
                ...
                <div class="col-md-2">
                   <a href="listexperiment.jsp" class="btn btn-warning" >Edit</a>
                </div>
