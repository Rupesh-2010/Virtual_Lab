...
%>
          ...
          <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Inputcollegename" placeholder="Enter College name" onkeypress="javascript:return isString(event)" name="collegename">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">College Image/File</label>
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" id="collegeInputFile" name="collegeimg">
                  ...
                  <div class="form-group">
                        ...
                        <textarea name="collegedesc" class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"></textarea>
                      </div>
                ...
                <div class="col-md-2">
                    <a href="listcollege.jsp" class="btn btn-warning" >Edit</a>
                </div>
