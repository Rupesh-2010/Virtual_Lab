    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1>Update Practical</h1>
          </div>
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Update Practical Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h1 class="card-title">Practical</h1>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="addexperiment" method="POST">
                  
                <div class="card-body">
                    
                        <div class="col-6">
                    <label>Id</label>
                    <input type="text" name="experiment_id" value="<%=request.getParameter("experiment_id")%>"  class="form-control" placeholder="Enter id" >
                    </div>
                    <div class="row mb-2">
          <div class="col-sm-6">
                          ...
                          }catch(Exception ex)
{
                  ...
                  <div class="form-group">
                  <label for="compiler_link">Compiler Link</label>
                  <select class="custom-select form-control-border" id="collegeSelect" name="compiler_link">
                      <option value="">Select Compiler</option>
                          ...
                          %>
                          <option><%=rs.getString("compiler_link")%></option>
                          <%
                          }
                          }catch(Exception ex)
{
                    ...
                    <div class="form-group">
                    <label for="Inputcollegename">Practical Title</label>
                    <input type="text" class="form-control" value="<%=request.getParameter("experiment_name")%>" id="Inputcollegename" placeholder="Enter Practical Title" onkeypress="javascript:return isString(event)" name="exptname">
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                  <div class="form-group">
                    <label for="exampleInputFile">Practical PDF/File</label>
                    <div class="input-group">
                      <div class="custom-file">
                          <input type="file" class="custom-file-input" value="<%=request.getParameter("experiment_file")%>" id="NotesInputFile" name="exptfile">
                  ...
                  <div class="form-group">
                        <label>Practical Description</label>
                        <textarea name="exptdesc" class="form-control" rows="3" placeholder="Enter Discription....." onkeypress="javascript:return isAlphanumric(event)"><%=request.getParameter("experiment_descrip")%></textarea>
                      </div>
