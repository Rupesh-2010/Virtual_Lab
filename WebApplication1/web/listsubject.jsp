              ...
              <li class="nav-item ">
                ...
                <a href="listclass.jsp" class="nav-link">
                  ...
                  <p>List Class</p>
                            ...
                            <li class="nav-item ">
                <a href="listsubject.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Subject</p>
                </a>
              </li>
   ...
   Statement st=null;
       ...
       try
       {
         ...
         <form action="update_subject.jsp" method="POST">
               ...
               <input type="hidden" name="subject_id" value="<%=rs.getString("subject_id")%>" >   
        ...
        <td><%=rs.getString("subject_descrip")%></td>
        <input type="hidden" name="subject_descrip" value="<%=rs.getString("subject_descrip")%>">
