        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Result Add Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                          ...
                          }catch(Exception ex)
{
          ...
          <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Inputusername" placeholder="Username" onkeypress="javascript:return isAlphanumric(event)" name="username">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="resultInputFile" name="resultfile">
                ...
                <div class="col-md-2">
                  <a href="listresult.jsp" class="btn btn-warning" >Edit</a>
                </div>
